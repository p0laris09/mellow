...
class EmailUpdateSent extends StatefulWidget {
  const EmailUpdateSent({super.key});

  @override
  State<EmailUpdateSent> createState() => _EmailUpdateSentState();
}

class _EmailUpdateSentState extends State<EmailUpdateSent> {
  @override
